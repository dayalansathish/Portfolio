  ...
  return (
    ...
    <div className='container'>
      ...
      <div className='about-empty p-0'>
        <div className='row'>
          <div className='col-5 '>
            <img src='profile.jpeg' width={"400px"} height={"450px"} className='m-5 p-0 rounded-5 img' />
          </div>
          <div className='col-6 m-auto'>
            ...
            <a class="mx-3" href='https://www.instagram.com/smokey_sk/?next=%2F' target='_blank'>
              <i class="fa fa-instagram text-black fs-3" aria-hidden="true"></i>
            </a>
            <a class="mx-3" href=''>
              <i class="fa fa-facebook text-black fs-3" aria-hidden="true"></i>
            </a>
            <a class="mx-3" href='https://twitter.com/skvilla_25' target='_blank'>
              <i class="fa fa-twitter text-black fs-3" aria-hidden="true"></i>
            </a>
